...
class CustomerController extends Controller
{
    ...
    // if($request->status){
    //     $customers = User::where('status',$request->status)->paginate(10);
    // }elseif($request->name){
    //     $customers = User::where('name','like', '%'.$request->name.'%')->paginate(10);
    // }elseif($request->email){
    //     $customers = User::where('email','like', '%'.$request->email.'%')->paginate(10);
    // }else{
