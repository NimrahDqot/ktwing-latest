...
class EventAudioRequest extends Model
{
    use SoftDeletes;
    protected $table = 'event_audio_complete_requests';
    protected $fillable = [
        'volunteer_id', 'event_id','uploaded_photos', 'uploaded_videos', 'uploaded_audios', 'status',
    ];
