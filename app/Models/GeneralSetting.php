...
class GeneralSetting extends Model
{
    protected $fillable = [
        ...
        'flutterwave_status',
        'mollie_api_key',
        'footer_address_1_heading',
        'footer_address_2_heading',
        'footer_another_address',
        'footer_other_phone',
        'mollie_status',
        'minimum_recharge_amount', 'minimum_withdraw_amount', 'invite_bonus_amount', 'recharge_bonus', 'level_1_comm_pers', 'level_2_comm_pers',
    ];
