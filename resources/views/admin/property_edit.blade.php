                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="property_type" class="form-control"  id="propertyType">
                                                ...
                                                <option value="For Home Stay" @if($property->property_type == 'For Home Stay') selected @endif>{{FOR_HOME_STAY}}</option>
                                                <option value="For Construction" @if($property->property_type == 'For Construction') selected @endif onchange="changeStatus()">{{ FOR_CONSTRUCTION }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 align-self-center construction_status d-none">
                                        <div class="d-flex">
                                            <div class="form-check mr-3">
                                                <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault1" value="Ongoing" @if($property->construction_property_status == 'Ongoing') checked @endif >
                                                <label class="form-check-label" for="flexRadioDefault1">Ongoing</label>
                                              </div>
                                              <div class="form-check mr-3">
                                                <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault2" value="Completed" @if($property->construction_property_status == 'Completed') checked @endif >
                                                <label class="form-check-label" for="flexRadioDefault2">Completed</label>
                                              </div>
                                              <div class="form-check">
                                                <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault3" value="Upcomming" @if($property->construction_property_status == 'Upcomming') checked @endif >
                                                <label class="form-check-label" for="flexRadioDefault3">Upcomming</label>
                                              </div>
                                        </div>
                                </div>
                                </div>
...
<script>
    // $('.construction_status').addClass('d-none');
    $(function(){
            // Function to check the current value of propertyType and toggle construction_status
            function checkPropertyType() {
                $('.construction_status').toggleClass('d-none', $('#propertyType').val() !== 'For Construction');
            }

            // Initial check when the page loads
            checkPropertyType();

            // Check when the propertyType value changes
    ...
    //     $('.construction_status').addClass('d-none');
    //     $('#propertyType').change(function(){
    //         if ($(this).val() === 'For Construction') {
    //             $('.construction_status').removeClass('d-none');
    //         } else {
    //             $('.construction_status').addClass('d-none');
    //         }
    //     });
