...
@section('admin_content')
    ...
    <form action="{{ route('admin_activity_update',$social_media->id) }}" method="post" enctype="multipart/form-data" >
        @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $social_media->title }}" autofocus>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="">{{ URL }} *</label>
                            <input type="text" name="video_url" class="form-control" value="{{ $social_media->video_url }}" autofocus>
                        </div>
                    </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <img id="output" class="w_150" style="cursor: pointer;" onclick="zoomImage(this)" src="{{ asset($social_media->image )}}" />
                        </div>
