                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="property_type" class="form-control" id="propertyType">
                                                ...
                                                <option value="For Construction" onchange="changeStatus()">{{ FOR_CONSTRUCTION }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4 align-self-center construction_status">
                                            <div class="d-flex">
                                                <div class="form-check mr-3">
                                                    <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault1" value="Ongoing">
                                                    <label class="form-check-label" for="flexRadioDefault1">Ongoing</label>
                                                  </div>
                                                  <div class="form-check mr-3">
                                                    <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault2" value="Completed" checked>
                                                    <label class="form-check-label" for="flexRadioDefault2">Completed</label>
                                                  </div>
                                                  <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="construction_property_status" id="flexRadioDefault3" value="Upcomming">
...
<script>
        ...
        $(function(){
            $('#propertyType').change(function(){
                $('.construction_status').toggleClass('d-none', $(this).val() !== 'For Construction');
            });
        });
