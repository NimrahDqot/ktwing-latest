                    ...
                    <div class="col-3">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="p4_tab" data-toggle="pill" href="#p4" role="tab"
                                aria-controls="p4" aria-selected="false">{{ GOOGLE_RECAPTCHA }}</a> --}}
                            ...
                            {{-- <a class="nav-link" id="p9_tab" data-toggle="pill" href="#p9" role="tab"
                                aria-controls="p9" aria-selected="false">{{ CUSTOMER_PROPERTY_OPTION }}</a> --}}
                            <a class="nav-link" id="p3_tab" data-toggle="pill" href="#p3" role="tab" aria-controls="p3" aria-selected="false">{{ LAYOUT_DIRECTION }}</a>
                            <a class="nav-link" id="p14_tab" data-toggle="pill" href="#p14" role="tab" aria-controls="p14" aria-selected="false">Amount</a>
                        </div>
                    </div>
                    <div class="col-9">
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="p3" role="tabpanel" aria-labelledby="p3_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="footer_column_1_heading" class="form-control"
                                        value="{{ $setting->footer_column_1_heading }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ FOOTER_COLUMN_1_TOTAL_ITEM }}</label>
                                    <input type="text" name="footer_column_1_total_item" class="form-control"
                                        value="{{ $setting->footer_column_1_total_item }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ FOOTER_COLUMN_2_HEADING }}</label>
                                    <input type="text" name="footer_column_2_heading" class="form-control"
                                        value="{{ $setting->footer_column_2_heading }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ FOOTER_COLUMN_2_TOTAL_ITEM }}</label>
                                    <input type="text" name="footer_column_2_total_item" class="form-control"
                                        value="{{ $setting->footer_column_2_total_item }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ FOOTER_COLUMN_3_HEADING }}</label>
                                    <input type="text" name="footer_column_3_heading" class="form-control"
                                        value="{{ $setting->footer_column_3_heading }}">
                                </div>

                                <div class="form-group">
                                    <label for="">{{ FOOTER_COLUMN_4_HEADING }}</label>
                                    <input type="text" name="footer_column_4_heading" class="form-control"
                                        value="{{ $setting->footer_column_4_heading }}">
                                </div>
                            ...
                            <div class="tab-pane fade" id="p5" role="tabpanel" aria-labelledby="p5_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="google_analytic_tracking_id" class="form-control"
                                        value="{{ $setting->google_analytic_tracking_id }}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="google_analytic_status" class="form-control">
                                        <option value="Show"
                                            {{ $setting->google_analytic_status == 'Show' ? 'selected' : '' }}>
                                            {{ SHOW }}</option>
                                        <option value="Hide"
                                            {{ $setting->google_analytic_status == 'Hide' ? 'selected' : '' }}>
                                            {{ HIDE }}</option>
                                    </select>
                                </div>
                                <!-- // Tab Content -->
                            ...
                            <div class="tab-pane fade" id="p6" role="tabpanel" aria-labelledby="p6_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tawk_live_chat_property_id" class="form-control"
                                        value="{{ $setting->tawk_live_chat_property_id }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ TAWK_LIVE_CHAT_STATUS }}</label>
                                    <select name="tawk_live_chat_status" class="form-control">
                                        <option value="Show"
                                            {{ $setting->tawk_live_chat_status == 'Show' ? 'selected' : '' }}>
                                            {{ SHOW }}</option>
                                        <option value="Hide"
                                            {{ $setting->tawk_live_chat_status == 'Hide' ? 'selected' : '' }}>
                                            {{ HIDE }}</option>
                                    </select>
                                </div>
                                <!-- // Tab Content -->
                            ...
                            <div class="tab-pane fade" id="p7" role="tabpanel" aria-labelledby="p7_tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cookie_consent_button_text" class="form-control"
                                        value="{{ $setting->cookie_consent_button_text }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ COOKIE_CONSENT_TEXT_COLOR }}</label>
                                    <input type="text" name="cookie_consent_text_color" class="form-control jscolor"
                                        value="{{ $setting->cookie_consent_text_color }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ COOKIE_CONSENT_BACKGROUND_COLOR }}</label>
                                    <input type="text" name="cookie_consent_bg_color" class="form-control jscolor"
                                        value="{{ $setting->cookie_consent_bg_color }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ COOKIE_CONSENT_BUTTON_TEXT_COLOR }}</label>
                                    <input type="text" name="cookie_consent_button_text_color"
                                        class="form-control jscolor"
                                        value="{{ $setting->cookie_consent_button_text_color }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ COOKIE_CONSENT_BUTTON_BACKGROUND_COLOR }}</label>
                                    <input type="text" name="cookie_consent_button_bg_color"
                                        class="form-control jscolor"
                                        value="{{ $setting->cookie_consent_button_bg_color }}">
                                </div>
                                <div class="form-group">
                                    <label for="">{{ COOKIE_CONSENT_STATUS }}</label>
                                    <select name="cookie_consent_status" class="form-control">
                                        <option value="Show"
                                            {{ $setting->cookie_consent_status == 'Show' ? 'selected' : '' }}>
                                            {{ SHOW }}</option>
                                        <option value="Hide"
                                            {{ $setting->cookie_consent_status == 'Hide' ? 'selected' : '' }}>
                                            {{ HIDE }}</option>
                                    </select>
                                </div>
                                <!-- // Tab Content -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="customer_property_option" class="form-control">
                                                <option value="On" @if ($setting->customer_property_option == 'On') selected @endif>
                                                    {{ ON }}</option>
                                                <option value="Off" @if ($setting->customer_property_option == 'Off') selected @endif>
                                                    {{ OFF }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="layout_direction" class="form-control">
                                                <option value="ltr" @if ($setting->layout_direction == 'ltr') selected @endif>
                                                    {{ LTR }}</option>
                                                <option value="rtl" @if ($setting->layout_direction == 'rtl') selected @endif>
                                                    {{ RTL }}</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="p14" role="tabpanel" aria-labelledby="p14_tab">

                                <!-- Tab Content -->
                                <div class="form-group">
                                    <label for="">Minium Recharge Amount</label>
                                    <input type="number"  step="0.01" name="minimum_recharge_amount" class="form-control"
                                        value="{{ $setting->minimum_recharge_amount }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Minimum Withdrawal Amount</label>
                                    <input type="number"  step="0.01" name="minimum_withdraw_amount" class="form-control"
                                        value="{{ $setting->minimum_withdraw_amount }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Invite Bonus Amount</label>
                                    <input type="number"  step="0.01" name="invite_bonus_amount" class="form-control"
                                        value="{{ $setting->invite_bonus_amount }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Recharge Bonus [in %]</label>
                                    <input type="number"  step="0.01" name="recharge_bonus" class="form-control"
                                        value="{{ $setting->recharge_bonus }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Level1 Commission Percent [in %]</label>
                                    <input type="number"  step="0.01" name="level_1_comm_pers" class="form-control"
                                        value="{{ $setting->level_1_comm_pers }}">
                                </div>

                                <div class="form-group">
                                    <label for="">Level2 Commission Percent [in %]</label>
                                    <input type="number"  step="0.01" name="level_2_comm_pers" class="form-control"
                                        value="{{ $setting->level_2_comm_pers }}">
                                </div>
